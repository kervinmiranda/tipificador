...
if(isset($_SESSION['user'])){
	...
	function getAspects(){
		...
		$sql = $objdatabase->prepare("SELECT call_evaluacion_aspecto.id, call_evaluacion_aspecto.id_atributo, call_evaluacion_atributo.descripcion, call_evaluacion_aspecto.descripcion, call_evaluacion_aspecto.estatus FROM call_evaluacion_aspecto INNER JOIN call_evaluacion_atributo ON call_evaluacion_aspecto.id_atributo = call_evaluacion_atributo.id WHERE call_evaluacion_atributo.estatus = '1' AND call_evaluacion_aspecto.estatus = '1'");
