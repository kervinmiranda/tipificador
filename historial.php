...
//Mostrar opciones al seleccionar fila
	$('#lista tbody').on('click', 'tr', function(){		
		...
		if ((selected.length > 0) && (seleccion == false)){			
			seleccion = true;
			$('#tipo').append('<option value="seleccion">Selección</option>');
		}
		if ((selected.length == 0) && (seleccion == true)){			
			seleccion = false;
			$("#tipo option[value='seleccion']").remove();
		}		
	});
...
<body>
    ...
    <div class="col-xs-12 col-md-6" align="center">        
        ...
        <div align="center" class="col-xs-12 col-sm-1">
       		<img  name="filtro" id="filtro" src="imagenes/excel.png" alt="Exportar a Excel" class="cursor" data-toggle="tooltip" title="Exportar a Excel"/> 
        </div>
	<?php
    	}
    ?>
